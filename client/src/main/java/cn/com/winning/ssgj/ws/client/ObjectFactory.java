 ...
 * generated in the cn.com.winning.ssgj.ws.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Welcome_QNAME = new QName("http://www.demo.chensj.org/services/hello", "welcome");
    private final static QName _WelcomeResponse_QNAME = new QName("http://www.demo.chensj.org/services/hello", "welcomeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.com.winning.ssgj.ws.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.demo.chensj.org/services/hello", name = "welcome")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.demo.chensj.org/services/hello", name = "welcomeResponse")
